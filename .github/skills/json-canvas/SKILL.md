...
6. **Validate**: Confirm both `fromNode` and `toNode` reference existing node IDs
...
3. Required fields are present for each node type (`text`, `file`, `url`)
...
- [EXAMPLES.md](references/EXAMPLES.md) — Full canvas examples (mind maps, project boards, flowcharts)
